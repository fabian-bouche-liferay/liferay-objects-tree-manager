        ...
        ReactDOM.render(
            <ReactFlowProvider>  
                <GraphEditor
                    ...
                    nodeService={new NodeService(this.baseURL, this.authString, this.client, this.nodeObjectName, this.treeObjectName, this.treeNodesRelationshipName, this.treeNodesRelationshipId, this.nodeTitle, this.nodeText, this.nodeRoot, this.xPosition, this.yPosition)}
